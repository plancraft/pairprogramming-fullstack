      ...
      <div className="main-page">
          ...
          <div className="action-suggestions">
            ...
            <div className="action-button-row">
              <button type="button" className="action-button">
                <span className="material-symbols-outlined action-icon">add_circle</span>
                Neues Projekt starten
              </button>
              <button type="button" className="action-button">
                <span className="material-symbols-outlined action-icon">history</span>
        ...
        <div className="content-card">
          ...
          <div className="project-row">
            ...
            <span className="project-expand material-symbols-outlined">keyboard_arrow_down</span>
          </div>
        ...
        <div className="dashboard-grid">
          <div className="content-card small-card">
            <div className="content-card-header">
              ...
              <span className="badge-new">4 offen</span>
            </div>
            ...
            <div className="todo-row">
              ...
              <div className="todo-main">
                <p className="todo-title">
                  Abschlagsrechnung fur Kunde Muller vorbereiten
                </p>
                <p className="todo-sub">Fallig heute · 10:30</p>
              </div>
            </div>
            ...
            <div className="todo-row">
              <div className="todo-check" />
              <div className="todo-main">
                <p className="todo-title">Ruckfrage zur Position 18 klaren</p>
                <p className="todo-sub">Fallig heute · 14:00</p>
              </div>
            </div>
            ...
            <div className="todo-row">
              ...
              <div className="todo-main">
                <p className="todo-title">
                  Projektstatus fur dschulia aktualisieren
                </p>
                <p className="todo-sub">Abgeschlossen · 08:05</p>
              </div>
            </div>
            ...
            <div className="todo-row">
              <div className="todo-check" />
              <div className="todo-main">
                <p className="todo-title">Angebot als PDF exportieren</p>
                <p className="todo-sub">Fallig morgen · 09:00</p>
              </div>
            </div>
          </div>
